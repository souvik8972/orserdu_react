...
const IMPORTANT_SAFETY_INFORMATION = () => {
  return (
    <div className="container  w-[80%] mt-5 list-disc marker:text-list_color text-[18px] font-[300] tracking-[0.09px]  list-outside leading-[20px]">
    <div className="bg-white  ">
      <h3 className="text-xl font-[500] mb-3 text-dark_green">IMPORTANT SAFETY INFORMATION</h3>
      ...
      <ul className="list-disc list-inside mb-4 flex flex-col gap-2">
        ...
        <ul className=" list-disc list-outside ml-8 flex flex-col gap-2 ">
          <p className="font-medium mb-2 mt-2 m">
      ...
      <ul className="list-disc list-inside mb-4 flex flex-col gap-2 text-start">
        <li>
      ...
      <p className="mb-4">
        ...
        effects to the FDA at 1-800-FDA-1088 or visit 
          <a
          className="text-dark_green ml-2 underline"
      ...
      <h3 className="text-xl font-medium mb-4 text-dark_green">INDICATION</h3>
      <p className="mb-4">
      ...
      <p className="font-medium text-[18px] mt-4">
        Please see full{" "}
        <a className="underline" href="http://pi.orserdu.com" target="_blank">
